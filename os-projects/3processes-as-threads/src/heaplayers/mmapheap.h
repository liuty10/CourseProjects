...
namespace HL {
  ...
  public:
    ...
    inline void * malloc (size_t sz) {
      ...
      void * ptr = mmap ((char *) Alignment, sz, HL_MMAP_PROTECTION_MASK, MAP_SHARED | MAP_ALIGN | MAP_ANON, -1, 0);
#elif !defined(MAP_ANONYMOUS)
      static int fd = ::open ("/dev/zero", O_RDWR);
      void * ptr = mmap (NULL, sz, HL_MMAP_PROTECTION_MASK, MAP_SHARED, fd, 0);
#else
      void * ptr = mmap (NULL, sz, HL_MMAP_PROTECTION_MASK, MAP_SHARED | MAP_ANONYMOUS, -1, 0);
#endif
      if (ptr == MAP_FAILED) {
	ptr = NULL;
      }
